...
describe('PageControls', () => {
    ...
    describe('for a single page', () => {
        it('should not render', () => {
            ...
            const { queryByTestId } = render(<PageControls pagination={pagination} setPagination={mockSetPagination} totalCount={10}/>);
    ...
    describe('for multiple pages', () => {
        it('should render controls', () => {
            ...
            const { getByTestId, getByText } = render(<PageControls pagination={pagination} setPagination={mockSetPagination} totalCount={100}/>);
        ...
        it('should move you to first page', () => {
            ...
            const { getByText } = render(<PageControls pagination={pagination} setPagination={mockSetPagination} totalCount={100}/>);

            expect(getByText('Page 3 of 5')).toBeInTheDocument();
            fireEvent.click(getByText('«'));
            
            waitFor(() => { expect(getByText('Page 1 of 5')).toBeInTheDocument(); });
        });
        ...
        it('should move you to previous page', () => {
            ...
            waitFor(() => { expect(getByText('Page 2 of 5')).toBeInTheDocument(); });
        });
        ...
        it('should move you to next page', () => {
            ...
            waitFor(() => { expect(getByText('Page 4 of 5')).toBeInTheDocument(); });
        });
        ...
        it('should move you to last page', () => {
            ...
            waitFor(() => { expect(getByText('Page 5 of 5')).toBeInTheDocument(); });
        });
    });
});